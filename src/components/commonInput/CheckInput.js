...
const CheckInput = ({question, type,handleChange,state}) => {
  ...
  return (
    ...
    <div className='d-flex justify-content-between'>
        ...
        <h5 className='fw-light mx-3 pt-3 check-title'>Excellent</h5>
        </div>
        <div className='d-flex align-items-center'>
        ...
        <h5 className='fw-light mx-3 pt-3 check-title'>Good</h5>
        </div>
        <div className='d-flex align-items-center'>
        ...
        <h5 className='fw-light mx-3 pt-3 check-title'>Fair</h5>
        </div>
        <div className='d-flex align-items-center'>
        ...
        <h5 className='fw-light mx-3 pt-3 check-title'>Bad</h5>
        </div>
